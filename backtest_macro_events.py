"""
Backtest: Macro Event Avoidance Filter Impact Analysis
Runs the same strategy twice (with and without macro event avoidance)
on top 50 coins, last 3 months, using live Binance data.

Macro events avoided (1 hour before and after):
...
Usage:
    python backtest_macro_events.py
"""
...
# ─── Macro Event Calendar Generator ───────────────────────────────────────────

# Known macro event schedules for 2025-2026 (actual historical dates)
# Format: (YYYY, MM, DD, HH, event_type, impact)
# These are approximate - in production you'd fetch from an economic calendar API
MACRO_EVENTS_2025_2026 = [
    # FOMC meetings (8 per year, typically Wed 14:00 UTC)
    (2025, 1, 29, 14, "FOMC", "HIGH"),
    (2025, 3, 19, 14, "FOMC", "HIGH"),
    (2025, 5, 7, 14, "FOMC", "HIGH"),
    (2025, 6, 18, 14, "FOMC", "HIGH"),
    (2025, 7, 30, 14, "FOMC", "HIGH"),
    (2025, 9, 17, 14, "FOMC", "HIGH"),
    (2025, 10, 29, 14, "FOMC", "HIGH"),
    (2025, 12, 17, 14, "FOMC", "HIGH"),
    (2026, 1, 28, 14, "FOMC", "HIGH"),
    (2026, 3, 18, 14, "FOMC", "HIGH"),
    (2026, 5, 6, 14, "FOMC", "HIGH"),
    (2026, 6, 17, 14, "FOMC", "HIGH"),

    # CPI (typically 2nd week of month, 14:00 UTC)
    (2025, 1, 15, 14, "CPI", "HIGH"),
    (2025, 2, 12, 14, "CPI", "HIGH"),
    (2025, 3, 12, 14, "CPI", "HIGH"),
    (2025, 4, 10, 14, "CPI", "HIGH"),
    (2025, 5, 13, 14, "CPI", "HIGH"),
    (2025, 6, 11, 14, "CPI", "HIGH"),
    (2025, 7, 15, 14, "CPI", "HIGH"),
    (2025, 8, 13, 14, "CPI", "HIGH"),
    (2025, 9, 10, 14, "CPI", "HIGH"),
    (2025, 10, 14, 14, "CPI", "HIGH"),
    (2025, 11, 12, 14, "CPI", "HIGH"),
    (2025, 12, 11, 14, "CPI", "HIGH"),
    (2026, 1, 14, 14, "CPI", "HIGH"),
    (2026, 2, 11, 14, "CPI", "HIGH"),
    (2026, 3, 11, 14, "CPI", "HIGH"),
    (2026, 4, 14, 14, "CPI", "HIGH"),
    (2026, 5, 12, 14, "CPI", "HIGH"),
    (2026, 6, 10, 14, "CPI", "HIGH"),

    # NFP (1st Friday of month, 14:00 UTC)
    (2025, 1, 10, 14, "NFP", "HIGH"),
    (2025, 2, 7, 14, "NFP", "HIGH"),
    (2025, 3, 7, 14, "NFP", "HIGH"),
    (2025, 4, 4, 14, "NFP", "HIGH"),
    (2025, 5, 2, 14, "NFP", "HIGH"),
    (2025, 6, 6, 14, "NFP", "HIGH"),
    (2025, 7, 4, 14, "NFP", "HIGH"),
    (2025, 8, 1, 14, "NFP", "HIGH"),
    (2025, 9, 5, 14, "NFP", "HIGH"),
    (2025, 10, 3, 14, "NFP", "HIGH"),
    (2025, 11, 7, 14, "NFP", "HIGH"),
    (2025, 12, 5, 14, "NFP", "HIGH"),
    (2026, 1, 2, 14, "NFP", "HIGH"),
    (2026, 2, 6, 14, "NFP", "HIGH"),
    (2026, 3, 6, 14, "NFP", "HIGH"),
    (2026, 4, 3, 14, "NFP", "HIGH"),
    (2026, 5, 1, 14, "NFP", "HIGH"),
    (2026, 6, 5, 14, "NFP", "HIGH"),

    # PPI (typically mid-month, 14:00 UTC)
    (2025, 1, 14, 14, "PPI", "MEDIUM"),
    (2025, 2, 18, 14, "PPI", "MEDIUM"),
    (2025, 3, 13, 14, "PPI", "MEDIUM"),
    (2025, 4, 11, 14, "PPI", "MEDIUM"),
    (2025, 5, 14, 14, "PPI", "MEDIUM"),
    (2025, 6, 12, 14, "PPI", "MEDIUM"),
    (2025, 7, 11, 14, "PPI", "MEDIUM"),
    (2025, 8, 13, 14, "PPI", "MEDIUM"),
    (2025, 9, 11, 14, "PPI", "MEDIUM"),
    (2025, 10, 14, 14, "PPI", "MEDIUM"),
    (2025, 11, 13, 14, "PPI", "MEDIUM"),
    (2025, 12, 12, 14, "PPI", "MEDIUM"),
    (2026, 1, 14, 14, "PPI", "MEDIUM"),
    (2026, 2, 18, 14, "PPI", "MEDIUM"),
    (2026, 3, 12, 14, "PPI", "MEDIUM"),
    (2026, 4, 10, 14, "PPI", "MEDIUM"),
    (2026, 5, 13, 14, "PPI", "MEDIUM"),
    (2026, 6, 11, 14, "PPI", "MEDIUM"),

    # Retail Sales (typically mid-month, 14:00 UTC)
    (2025, 1, 15, 14, "RETAIL", "MEDIUM"),
    (2025, 2, 14, 14, "RETAIL", "MEDIUM"),
    (2025, 3, 17, 14, "RETAIL", "MEDIUM"),
    (2025, 4, 15, 14, "RETAIL", "MEDIUM"),
    (2025, 5, 15, 14, "RETAIL", "MEDIUM"),
    (2025, 6, 17, 14, "RETAIL", "MEDIUM"),
    (2025, 7, 16, 14, "RETAIL", "MEDIUM"),
    (2025, 8, 14, 14, "RETAIL", "MEDIUM"),
    (2025, 9, 16, 14, "RETAIL", "MEDIUM"),
    (2025, 10, 16, 14, "RETAIL", "MEDIUM"),
    (2025, 11, 14, 14, "RETAIL", "MEDIUM"),
    (2025, 12, 17, 14, "RETAIL", "MEDIUM"),
    (2026, 1, 15, 14, "RETAIL", "MEDIUM"),
    (2026, 2, 17, 14, "RETAIL", "MEDIUM"),
    (2026, 3, 16, 14, "RETAIL", "MEDIUM"),
    (2026, 4, 14, 14, "RETAIL", "MEDIUM"),
    (2026, 5, 15, 14, "RETAIL", "MEDIUM"),
    (2026, 6, 16, 14, "RETAIL", "MEDIUM"),

    # GDP (quarterly, typically end of month)
    (2025, 1, 30, 14, "GDP", "HIGH"),
    (2025, 4, 30, 14, "GDP", "HIGH"),
    (2025, 7, 30, 14, "GDP", "HIGH"),
    (2025, 10, 30, 14, "GDP", "HIGH"),
    (2026, 1, 29, 14, "GDP", "HIGH"),

    # Jobless Claims (weekly, Thursdays 14:00 UTC)
    # Adding representative samples for 3-month backtest periods
    (2025, 1, 9, 14, "CLAIMS", "MEDIUM"),
    (2025, 1, 16, 14, "CLAIMS", "MEDIUM"),
    (2025, 1, 23, 14, "CLAIMS", "MEDIUM"),
    (2025, 1, 30, 14, "CLAIMS", "MEDIUM"),
    (2025, 2, 6, 14, "CLAIMS", "MEDIUM"),
    (2025, 2, 13, 14, "CLAIMS", "MEDIUM"),
    (2025, 2, 20, 14, "CLAIMS", "MEDIUM"),
    (2025, 2, 27, 14, "CLAIMS", "MEDIUM"),
    (2025, 3, 6, 14, "CLAIMS", "MEDIUM"),
    (2025, 3, 13, 14, "CLAIMS", "MEDIUM"),
    (2025, 3, 20, 14, "CLAIMS", "MEDIUM"),
    (2025, 3, 27, 14, "CLAIMS", "MEDIUM"),
    (2025, 4, 3, 14, "CLAIMS", "MEDIUM"),
    (2025, 4, 10, 14, "CLAIMS", "MEDIUM"),
    (2025, 4, 17, 14, "CLAIMS", "MEDIUM"),
    (2025, 4, 24, 14, "CLAIMS", "MEDIUM"),
    (2025, 5, 1, 14, "CLAIMS", "MEDIUM"),
    (2025, 5, 8, 14, "CLAIMS", "MEDIUM"),
    (2025, 5, 15, 14, "CLAIMS", "MEDIUM"),
    (2025, 5, 22, 14, "CLAIMS", "MEDIUM"),
    (2025, 5, 29, 14, "CLAIMS", "MEDIUM"),
    (2025, 6, 5, 14, "CLAIMS", "MEDIUM"),
    (2025, 6, 12, 14, "CLAIMS", "MEDIUM"),
    (2025, 6, 19, 14, "CLAIMS", "MEDIUM"),
    (2025, 6, 26, 14, "CLAIMS", "MEDIUM"),

    # ECB (quarterly, typically Thu)
    (2025, 1, 23, 14, "ECB", "HIGH"),
    (2025, 4, 17, 14, "ECB", "HIGH"),
    (2025, 7, 17, 14, "ECB", "HIGH"),
    (2025, 10, 16, 14, "ECB", "HIGH"),
    (2026, 1, 22, 14, "ECB", "HIGH"),

    # Fed Chair Speeches (approximate, monthly)
    (2025, 1, 8, 14, "SPEECH", "MEDIUM"),
    (2025, 2, 11, 14, "SPEECH", "MEDIUM"),
    (2025, 3, 4, 14, "SPEECH", "MEDIUM"),
    (2025, 4, 16, 14, "SPEECH", "MEDIUM"),
    (2025, 5, 7, 14, "SPEECH", "MEDIUM"),
    (2025, 6, 11, 14, "SPEECH", "MEDIUM"),
    (2025, 7, 9, 14, "SPEECH", "MEDIUM"),
    (2025, 8, 22, 14, "SPEECH", "MEDIUM"),
    (2025, 9, 17, 14, "SPEECH", "MEDIUM"),
    (2025, 10, 20, 14, "SPEECH", "MEDIUM"),
    (2025, 11, 13, 14, "SPEECH", "MEDIUM"),
    (2025, 12, 4, 14, "SPEECH", "MEDIUM"),
    (2026, 1, 29, 14, "SPEECH", "MEDIUM"),
    (2026, 2, 11, 14, "SPEECH", "MEDIUM"),
    (2026, 3, 4, 14, "SPEECH", "MEDIUM"),
    (2026, 4, 8, 14, "SPEECH", "MEDIUM"),
    (2026, 5, 7, 14, "SPEECH", "MEDIUM"),
    (2026, 6, 10, 14, "SPEECH", "MEDIUM"),
]


def get_macro_events_for_period(start_date: datetime, end_date: datetime) -> List[datetime]:
    """Get list of macro event datetimes within the backtest period."""
    events = []
    for year, month, day, hour, event_type, impact in MACRO_EVENTS_2025_2026:
        event_dt = datetime(year, month, day, hour, 0, 0, tzinfo=timezone.utc)
        if start_date <= event_dt <= end_date:
            events.append(event_dt)
    return sorted(events)


def is_during_macro_event(candle_time: datetime, macro_events: List[datetime],
                           buffer_hours: int = 1) -> bool:
    """Check if a candle time falls within buffer_hours of any macro event."""
    for event_time in macro_events:
        delta = abs((candle_time - event_time).total_seconds())
        if delta <= buffer_hours * 3600:
            return True
    return False
...
class Backtester:
    ...
    def run(self, symbol: str, interval: str = '1h', months: int = 3,
            macro_events: List[datetime] = None,
            macro_buffer_hours: int = 1) -> BacktestResult:
        ...
        while i < len(df) - 1:
            ...
            # ── MACRO EVENT AVOIDANCE FILTER ──────────────────────────────
            if macro_events:
                candle_time = df.index[i].tz_localize(timezone.utc) if df.index[i].tzinfo is None else df.index[i]
                if is_during_macro_event(candle_time, macro_events, macro_buffer_hours):
                    i += 1
                    continue
...
def print_comparison(results_without: list, results_with: list, months: int):
    print("\n")
    print("=" * 90)
    print("  MACRO EVENT AVOIDANCE FILTER IMPACT ANALYSIS")
    print(f"  Period: {months} months | TF: 1H | Top 50 coins by volume")
    print("  Macro Events Avoided: FOMC, CPI, NFP, PPI, GDP, Claims, ECB, Speeches")
    print("  Buffer: 1 hour before and after each event")
    print("=" * 90)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Macro Event Avoidance Filter Impact Analysis")
    ...
    parser.add_argument('--buffer', type=int, default=1, help='Hours before/after event to avoid')
    ...
    # Get macro events for the backtest period
    end_date = datetime.now(timezone.utc)
    start_date = end_date - timedelta(days=args.months * 30)
    macro_events = get_macro_events_for_period(start_date, end_date)
    print(f"\n📅 Found {len(macro_events)} macro events in the backtest period")
    print(f"   Events: FOMC, CPI, NFP, PPI, GDP, Claims, ECB, Speeches")
    print(f"   Buffer: {args.buffer} hour(s) before and after each event")

    print(f"\n🚀 Macro Event Backtest — {len(symbols)} coins | {args.months} months")
    ...
    for idx, sym in enumerate(symbols):
        ...
        print(f"  → WITHOUT macro event filter...")
        r_wo = backtester.run(sym, '1h', args.months, macro_events=None)
        results_without.append(r_wo)
        print(f"     {r_wo.total_trades} trades | WR: {r_wo.win_rate}% | RR: {r_wo.total_rr:+.1f}R")

        print(f"  → WITH macro event filter ({args.buffer}h buffer)...")
        r_w = backtester.run(sym, '1h', args.months, macro_events=macro_events, macro_buffer_hours=args.buffer)
        results_with.append(r_w)
        print(f"     {r_w.total_trades} trades | WR: {r_w.win_rate}% | RR: {r_w.total_rr:+.1f}R")

        time.sleep(0.3)

    print_comparison(results_without, results_with, args.months)
    ...
    if args.save:
        data = {
            ...
            'config': {
                ...
                'symbols': symbols,
                'macro_events': [e.isoformat() for e in macro_events],
            }
        }
        with open('backtest_macro_events_results.json', 'w') as f:
            json.dump(data, f, indent=2)
        print(f"💾 Saved to backtest_macro_events_results.json")
